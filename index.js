...
app.get('/jokes/:id', (req, res)=>{
    ...
    // const jokeIndex = parseInt(jokeId)-1;    // if dont use an extra function
    // const JokeById = jokes[jokeIndex];

    // const reqJ = getJokeById(jokeId)  // you use a function


    const foundJoke = jokes.find((joke)=>joke.id === jokeId); // one of the short way to did this
    res.json(foundJoke);
...
// const getJokeById=(id)=>{    // long way to get a specific joke
//    const jokeIndex = parseInt(id)-1;
...
app.get('/filter', (req,res)=>{
  ...
  if(filterJoke.length===0){
    return res.json({ message: 'No jokes found for the specified jokeType' });
  } 
     res.json(filterJoke);
